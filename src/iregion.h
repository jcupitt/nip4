...
#define IREGION_TYPE (iregion_get_type())
#define IREGION(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), IREGION_TYPE, iRegion))
#define IREGION_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), IREGION_TYPE, iRegionClass))
#define IS_IREGION(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), IREGION_TYPE))
#define IS_IREGION_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), IREGION_TYPE))
#define IREGION_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), IREGION_TYPE, iRegionClass))
