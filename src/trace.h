...
#define TRACE_TYPE (trace_get_type())
#define TRACE(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), TRACE_TYPE, Trace))
#define TRACE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), TRACE_TYPE, TraceClass))
#define IS_TRACE(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), TRACE_TYPE))
#define IS_TRACE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), TRACE_TYPE))
#define TRACE_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), TRACE_TYPE, TraceClass))
