...
#define PROGRESS(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), PROGRESS_TYPE, Progress))
#define PROGRESS_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), PROGRESS_TYPE, ProgressClass))
#define IS_PROGRESS(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), PROGRESS_TYPE))
#define IS_PROGRESS_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), PROGRESS_TYPE))
