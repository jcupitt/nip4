...
#define WORKSPACEGROUP_TYPE (workspacegroup_get_type())
#define WORKSPACEGROUP(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), \
		WORKSPACEGROUP_TYPE, Workspacegroup))
#define WORKSPACEGROUP_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), \
		WORKSPACEGROUP_TYPE, WorkspacegroupClass))
#define IS_WORKSPACEGROUP(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), WORKSPACEGROUP_TYPE))
#define IS_WORKSPACEGROUP_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), WORKSPACEGROUP_TYPE))
