...
#define MODEL_TYPE (model_get_type())
#define MODEL(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), MODEL_TYPE, Model))
#define MODEL_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), MODEL_TYPE, ModelClass))
#define IS_MODEL(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), MODEL_TYPE))
#define IS_MODEL_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), MODEL_TYPE))
#define MODEL_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), MODEL_TYPE, ModelClass))
...
typedef struct _ModelClass {
	...
	/* Change methods
		...
		edit			display an editor for the object
