...
#define TOOL_TYPE (tool_get_type())
#define TOOL(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), TOOL_TYPE, Tool))
#define TOOL_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), TOOL_TYPE, ToolClass))
#define IS_TOOL(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), TOOL_TYPE))
#define IS_TOOL_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), TOOL_TYPE))
