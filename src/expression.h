...
#define EXPRESSION_TYPE (expression_get_type())
#define EXPRESSION(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), EXPRESSION_TYPE, Expression))
#define EXPRESSION_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), EXPRESSION_TYPE, ExpressionClass))
#define IS_EXPRESSION(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), EXPRESSION_TYPE))
#define IS_EXPRESSION_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), EXPRESSION_TYPE))
#define EXPRESSION_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), EXPRESSION_TYPE, ExpressionClass))
