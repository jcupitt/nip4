...
#define OPTION_TYPE (option_get_type())
#define OPTION(obj) \
...
#define IS_OPTION_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), OPTION_TYPE))
#define OPTION_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), OPTION_TYPE, OptionClass))
