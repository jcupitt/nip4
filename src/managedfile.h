...
#define MANAGEDFILE_TYPE (managedfile_get_type())
#define MANAGEDFILE(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), MANAGEDFILE_TYPE, Managedfile))
#define MANAGEDFILE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), MANAGEDFILE_TYPE, ManagedfileClass))
#define IS_MANAGEDFILE(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), MANAGEDFILE_TYPE))
#define IS_MANAGEDFILE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), MANAGEDFILE_TYPE))
#define MANAGEDFILE_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), MANAGEDFILE_TYPE, ManagedfileClass))
