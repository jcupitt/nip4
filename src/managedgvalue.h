...
#define MANAGEDGVALUE_TYPE (managedgvalue_get_type())
#define MANAGEDGVALUE(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), MANAGEDGVALUE_TYPE, Managedgvalue))
#define MANAGEDGVALUE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), MANAGEDGVALUE_TYPE, ManagedgvalueClass))
#define IS_MANAGEDGVALUE(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), MANAGEDGVALUE_TYPE))
#define IS_MANAGEDGVALUE_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), MANAGEDGVALUE_TYPE))
#define MANAGEDGVALUE_GET_CLASS(obj) \
	(G_TYPE_INSTANCE_GET_CLASS((obj), MANAGEDGVALUE_TYPE, ManagedgvalueClass))
