...
#define PLOT(obj) \
	(G_TYPE_CHECK_INSTANCE_CAST((obj), PLOT_TYPE, Plot))
#define PLOT_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_CAST((klass), PLOT_TYPE, PlotClass))
#define IS_PLOT(obj) \
	(G_TYPE_CHECK_INSTANCE_TYPE((obj), PLOT_TYPE))
#define IS_PLOT_CLASS(klass) \
	(G_TYPE_CHECK_CLASS_TYPE((klass), PLOT_TYPE))
